...
public class Examples {
    ...
    {
        return new CompoundStatement(
                new CompoundStatement(new VariableDeclarationStatement("v", new ReferenceType(new IntType())),new VariableDeclarationStatement("a", new ReferenceType(new IntType()))),
                new CompoundStatement(new AssignStatement("a", new ValueExpression(new IntValue(20))),
